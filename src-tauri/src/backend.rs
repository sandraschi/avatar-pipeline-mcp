...
const BACKEND_NAME: &str = "avatar-pipeline-mcp-backend.exe";
const BACKEND_PORT: u16 = 11210;
const BACKEND_TAG: &str = "avatar-pipeline-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "AVATAR_PIPELINE_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 11210",
    ...
    Ok(format!("Backend starting on port 11210"))
}
